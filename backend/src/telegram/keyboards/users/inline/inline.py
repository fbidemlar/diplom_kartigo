...
def social_links() -> InlineKeyboardMarkup:
    official_site = 'https://t.me/kartigo'
    ...
    official_site_btn = InlineKeyboardButton(text='Официальный сайт', url=official_site)
    ...
    markup = InlineKeyboardMarkup(inline_keyboard=[[official_site_btn], [instagram_btn], [sell_link_btn]])
    return markup